...
::: {.dataset-citation}
Source dataset from Braun et al. (2022), *Journal of Power Sources*, describing "fresh and pre-aged lithium-ion battery single cells operated under well-defined laboratory conditions." [doi:10.1016/j.jpowsour.2022.231828](https://doi.org/10.1016/j.jpowsour.2022.231828)
:::
...
::: {.column width="45%"}
### Feature Ranking
1. **Cumulative charge ($Q_{cum}$)** — dominant predictor, encoding the battery's running charge history.
2. **Voltage ($V$)** — strong electrochemical indicator, linked to SoC through the OCV relationship.
3. **Temperature ($T$)** and **Current ($I$)** — secondary context for thermal and operating-state corrections.
:::
::::
...
::: {.column width="45%"}
### Observations
- Both models assign the strongest influence to **cumulative charge ($Q_{cum}$)**.
- **Voltage** remains the next key signal, while **temperature** and **current** act as supporting context.
